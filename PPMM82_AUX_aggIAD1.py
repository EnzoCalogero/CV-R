...
Host="10.4.219.22"
host="CS801"
dest="c:/dati/AUX_Analisis/IAD1/"+host+ "Pre.txt"
src="//10.4.219.22/c$/rs-pkgs/OMSA/MM82.txt"    
...
#  os.system('sox input.wav -b 24 output.aiff rate -v -L -b 90 48k')  
  cmd1="cmd.exe /a /c TYPE c:\dati\AUX_Analisis\IAD1\\"+host+ "Pre.txt > c:\dati\AUX_Analisis\IAD1\\"+host+ ".txt"
#  print(cmd1)
  os.system(cmd1)
...
text_fileOut = open("C:/dati/AUX_Analisis/IAD1/globalIAD1.csv", "w")
...
for CS in CommCells:
    ...
    inputFile="C:/dati/AUX_Analisis/IAD1/"+CS+".txt"
