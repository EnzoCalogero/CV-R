...
```{r,warning=FALSE,echo=FALSE,message=FALSE,fig.height=6,fig.width=12}
  ...
  ##import the file
  file='C:/dati/Jobs_Analisis/ord1/globalJobsord1.csv'
...
```{r, echo=FALSE,fig.height=6,fig.width=12}
  #CS401
  AUX_Aggregate<-subset(AUX_Aggregate_CS,AUX_Aggregate_CS$CS=="CS901")
  ...
  rm(Jobs)
  dygraph(xts_Jobs_401,main="CS901",group = "Ord1")%>% dyRangeSelector()
...
```{r, echo=FALSE,fig.height=6,fig.width=12}
  #CS402
  AUX_Aggregate<-subset(AUX_Aggregate_CS,AUX_Aggregate_CS$CS=="CS902")
  AUX_Aggregate$CS<-NULL
  ...
  rm(Jobs)
  dygraph(xts_Jobs_402,main="CS902",group = "Ord1")%>% dyRangeSelector()
 
```

```{r, echo=FALSE,fig.height=6,fig.width=12}
  #CS403
  AUX_Aggregate<-subset(AUX_Aggregate_CS,AUX_Aggregate_CS$CS=="CS903")
  AUX_Aggregate$CS<-NULL
  ...
  rm(Jobs)
  dygraph(xts_Jobs_403,main="CS903",group = "Ord1")%>% dyRangeSelector()
  
```

```{r, echo=FALSE,fig.height=6,fig.width=12}
  #CS402
  AUX_Aggregate<-subset(AUX_Aggregate_CS,AUX_Aggregate_CS$CS=="CS904")
  AUX_Aggregate$CS<-NULL
  ...
  rm(Jobs)
  dygraph(xts_Jobs_404,main="CS904",group = "Ord1")%>% dyRangeSelector()
```

```{r, echo=FALSE,fig.height=6,fig.width=12}
  #CS402
  AUX_Aggregate<-subset(AUX_Aggregate_CS,AUX_Aggregate_CS$CS=="CS905")
  AUX_Aggregate$CS<-NULL
  ...
  rm(Jobs)
  dygraph(xts_Jobs_406,main="CS905",group = "Ord1")%>% dyRangeSelector()#%>%
 
```

```{r, echo=FALSE,fig.height=6,fig.width=12}
  #CS402
  AUX_Aggregate<-subset(AUX_Aggregate_CS,AUX_Aggregate_CS$CS=="CS906")
  AUX_Aggregate$CS<-NULL
  ...
  rm(Jobs)
  dygraph(xts_Jobs_410,main="CS906",group = "ord1")%>% dyRangeSelector()#%>%
